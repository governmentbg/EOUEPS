...
namespace EPayments.Data.ViewObjects.Web.APGModels.Requests
{
    public class APGWPaymentRequestDataVO : APGWRequestBase
    {
        ...
        [Display(Name = "BACKREF")]
        public string Backref
        {
            get { return AppSettings.EPaymentsWeb_CentralVposBackref; }
        }
        ...
        public override ICollection<KeyValuePair<string, string>> RequestFields()
        {
            List<KeyValuePair<string, string>> fields = new List<KeyValuePair<string, string>>()
            {
                ...
                new KeyValuePair<string, string>(base.GetFieldName(() => this.Backref, nameof(this.Backref)), this.Backref),
        ...
        public override string ToString()
        {
            ...
            sb.Append(", TrType: ").Append(TrType);
            ...
            sb.Append(", Backref: ").Append(Backref);
            return sb.ToString();
        }
    }
}
