...
namespace EPayments.Model.DataObjects.EmailTemplateContext
{
    public class StatusChangedObligationContextDO
    {
        ...
        public StatusChangedObligationContextDO(string paymentRequestIdentifier, string serviceProviderName, string paymentReason, decimal paymentAmount, string statusObligation, DateTime createDate)
        {
