...
namespace EPayments.Model.DataObjects.EmailTemplateContext
{
    public class AccessCodeActivatedContextDO
    {
        ...
        public AccessCodeActivatedContextDO(string applicantName, string accessCode, string paymentRequestIdentifier, string serviceProviderName, string paymentReason, decimal paymentAmount, DateTime createDate)
        {
